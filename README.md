...
# 3\. Open the standard \*\*Serial Monitor\*\* (plug icon). The board will output performance matrices comparing Z-Score and Hampel filters at various injection probabilities. You can edit the `ANOMALY\_PROB` and `FILTER\_WINDOW` constants at the top of `src/bonus.cpp` to test different scenarios.
